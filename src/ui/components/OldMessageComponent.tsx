...
//   ({ message, prevMessage, autoExpandTools = false }) => {
//     const isGrouped =
//       prevMessage &&
//       prevMessage.type === message.type &&
//       prevMessage.type === 'assistant' &&
//       !(prevMessage as any).isToolUse &&
//       !message.isToolUse;
...
//         const textItem = message.message.content.find(
...
//                     </div>
//                   ) : (
//                     <div className="whitespace-pre-wrap">{formatUsageLimitText(content)}</div>
//                   )}
//                 </div>
//               )}
